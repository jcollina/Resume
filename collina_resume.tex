...
% Author : Jared Collina and Nanu Panchamurthy
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Jared Collina \vspace{2pt}} & % row = 1, col = 1
  Philadelphia, PA \\ % row = 1, col = 2
 % \href{https://jane-doe.com}{\uline{jane-doe.com}} $|$ % row = 2, col = 1
  \href{https://linkedin.com/in/jaredcollina}{\uline{LinkedIn}} $|$ % row = 2, col = 1
  \href{https://github.com/jcollina}{\uline{GitHub}} $|$ % row = 2, col = 1
 % \href{https://leetcode.com/jane-doe}{\uline{Leetcode}} & % row = 2, col = 1
  Email: \href{mailto:jscollina@gmail.com}{\uline{jscollina@gmail.com}} $|$ % row = 2, col = 2
  Mobile: (202)360-8487 \\ % row = 2, col = 2
\end{tabular*}
%--------------------------------------------
...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Neuroscience Ph.D. Researcher}{Aug 2018 -- Present}
  {University of Pennsylvania}{Philadelphia, PA}
    \resumeItemListStart{}
	\resumeItem{Created an \textbf{integrated cloud-based analysis pipeline using AWS and Python} to synchronize neural data from multi-channel arrays with behavioral data, streamlining the data extraction, cleaning, and transformation processes.}
      \resumeItem{Developed an \textbf{open-source Matlab toolbox} as part of a multidisciplinary team that was used by other research labs to model image formation in the tree shrew visual system (\uline{\href{https://t.ly/qxoR4}{Code}}).}
      \resumeItem{Led a team of researchers in implementing time-series clustering alongside a \textbf{custom reinforcement learning model in Python} to study the role of the primary auditory cortex in the learning of auditory categories (\uline{\href{https://t.ly/vpwu0}{Paper}}, \uline{\href{https://t.ly/ndyl0}{Code}}).}
      \resumeItem{Showed that variability in how humans disregard irrelevant auditory information can be captured by a \textbf{Bayesian graphical model}, yielding a tool for studying how humans navigate complex auditory environments (\uline{\href{https://t.ly/sLwHc}{Paper}}).}
	\resumeItem{Mentored graduate students and post-doctoral researchers in \textbf{data visualization and computational modeling}, and served as TA for a 30-student undergraduate introduction to MATLAB course.}
    \resumeItemListEnd{}

  \resumeQuadHeading{Statistics M.A. Researcher}{Aug 2019 -- Present}
  {University of Pennsylvania}{Philadelphia, PA}
    \resumeItemListStart{}
      \resumeItem{Collaborated with a multidisciplinary team to design and implement a specialized reinforcement learning model in Python tailored to optimize maze navigation within a dynamic environment.}
    \resumeItemListEnd{}

  \resumeQuadHeading{Engineering Research Intern}{May 2015 -- Aug 2015}
  {AnthroTronix} {Silver Spring, MD}
    \resumeItemListStart{}
      \resumeItem{Organized and analyzed data from human subject research. My findings were used to optimize a battery of tests that, combined, were able to diagnose signs of early onset PTSD.}
    \resumeItemListEnd{}
...
\section{Education}
  \resumeHeadingListStart{}
    \resumeQuadHeading{University of Pennsylvania}{Philadelphia, PA}
 {Ph.D. in Neuroscience}{Aug 2018 -- Feb 2025 (Expected)}
    \resumeQuadHeading{University of Pennsylvania}{Philadelphia, PA}
 {M.A. in Statistics}{Aug 2019 -- Feb 2025 (Expected)}
    \resumeQuadHeading{Haverford College}{Haverford, PA}
 {B.S. in Physics}{Aug 2014 -- May 2018}
...
\section{Leadership}
  \resumeItemListStart{}
    \resumeItem{\textbf{Comp. Neuro Section Chief, Brains in Briefs} (training Ph.D. students to make technical literature more accessible)}
    \resumeItem{\textbf{Founder, Biomedical Graduate Studies Program Club Soccer} (school-funded soccer club accessible to all graduate students)}
    \resumeItem{\textbf{Volunteer Coach, Philadelphia Open Soccer} (free soccer for low-income youth in West Philadelphia)}
    \resumeItem{\textbf{Seminar Committee Member, Computational Neuroscience Initiative} (Organized interdisciplinary seminars attended by dozens of community members) }
  \resumeItemListEnd{}
%--------------------------------------------
